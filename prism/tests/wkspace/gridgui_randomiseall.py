...
def allDone():
    ...
    #randomise failstates blindly really 
    ...
    smap=gfr.generateFromGUIGrid(initStates,blockedStates,goalStates,avoidStates,failStates,connectedStates,doorPairs,xside,yside,fn+"_fsgen0_",doFour)
    for ij in smap:
        i = ij[0]
        j = ij[1]
        lab = smap[ij]
...
if __name__ == "__main__" :
    ...
    menu.add_command(label='Center Goals', command=centerGoals)
    menu.add_command(label='Side Goals',command=sideClusterGoals)
