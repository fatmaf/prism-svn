...
tloc="${PWD}/" #"/home/fatma/hubic/phD/work/code/mdpltl/prism-svn/prism/tests/fatma_tests/tests_final/"
trloc="${PWD}/res/" #/home/fatma/hubic/phD/work/code/mdpltl/prism-svn/prism/tests/fatma_tests/tests_final/res/"

for tfns in $(ls *.prism); do
    fn="${tfns##*/}"
    tfn="${fn%.*}"
    echo "=================================================="
