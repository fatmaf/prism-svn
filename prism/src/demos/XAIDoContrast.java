...
public class XAIDoContrast
{
	...
	public static void main(String[] args)
	{
		...
		try {
			docontrast.identifySwingStatesContext();
		} catch (Exception e) {
	...
	public void identifySwingStatesContext() throws Exception
	{
		...
		for (String filename : filenames) {
			...
			if (prevSSTop != null) {
				...
				sa.listClosestStatesToStateOnTheFly(prevSSTop, optimalPolicyStateDistancesFromAllStates, optimalPolicyPaths,mdpDistshm, sa.mdp,vi.productmdp,optimalPolicy);
			}
			if (prevSSTop == null)
				prevSSTop = ssTop;
			...
			if (prevSSBottom != null) {
				...
				sa.listClosestStatesToStateOnTheFly(prevSSBottom, optimalPolicyStateDistancesFromAllStates, optimalPolicyPaths,mdpDistshm, sa.mdp,vi.productmdp,optimalPolicy);
