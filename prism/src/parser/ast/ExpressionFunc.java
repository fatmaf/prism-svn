...
public class ExpressionFunc extends Expression
{
	...
	public static final int PARTIAL = 9;
        public static final int APPROX = 10;
	// Built-in function names
	public static final String names[] = { "min", "max", "floor", "ceil", "round", "pow", "mod", "log", "multi", "partial", "approx" };
	// Min/max function arities
	public static final int minArities[] = { 2, 2, 1, 1, 1, 2, 2, 2, 1, 1 , 1 };
	public static final int maxArities[] = { -1, -1, 1, 1, 1, 2, 2, 2, -1, -1, -1 };
