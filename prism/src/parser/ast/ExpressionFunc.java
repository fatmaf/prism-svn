...
public class ExpressionFunc extends Expression
{
	...
	public static final int STAPU = 9;
	//public static final int SKIPPING = 9;	//f: to test ws
	// Built-in function names
	public static final String names[] = { "min", "max", "floor", "ceil", "pow", "mod", "log", "multi", "partial", "stapu"};//,"skipping"}; //f: added skipping for ws 
